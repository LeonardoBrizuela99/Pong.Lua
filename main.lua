...
local paddleLeft = { x = 50, y = 250, width = 10, height = 60, speed = 400,color=playerLeftColor }
local paddleRight = { x = 740, y = 250, width = 10, height = 60, speed = 400,color=playerRightColor }
...
function love.draw()
    ...
    elseif gameState == "game" then
        ...
        love.graphics.setColor(paddleLeft.color)
        love.graphics.print("Player 1: " .. scoreLeft, 50, 50)
        love.graphics.setColor(paddleRight.color)
        love.graphics.print("Player 2: " .. scoreRight, 650, 50)
